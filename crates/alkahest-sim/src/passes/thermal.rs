...
/// Create the thermal diffusion compute pipeline.
/// Workgroup is 8x8x4 = 256. Chunk is 32x32x32. Dispatch is 4x4x8 workgroups.
pub fn create_thermal_pipeline(
    device: &wgpu::Device,
...
/// Dispatch the thermal diffusion pass over the full chunk.
/// Workgroup is 8x8x4, chunk is 32x32x32, so dispatch (4, 4, 8) workgroups.
pub fn dispatch_thermal(
