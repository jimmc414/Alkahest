...
/// Execute the remove tool: clear voxels at the given local position with brush settings.
...
pub fn execute(
    ...
    commands::remove_voxel(sim, x, y, z, chunk_dispatch_idx, brush_radius, brush_shape);
}
